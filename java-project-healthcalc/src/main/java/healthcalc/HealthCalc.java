...
public interface HealthCalc {
	 ...
	 *
	 * @param person	The person for whom to calculate the BMI.
...
=======
	 ...
	 * 
	 * @param person	The person for whom to calculate the IBW.
     ...
     * @param person	The person for whom to calculate the BSA.
